...
# Tier -> worker failover order. Cerebras leads both tiers (fast inference);
# Gemini remains as long-context fallback for LARGE. HUGE is rejected
# (Summarizer Agent will live in V7).
TIER_TO_ORDER = {
    "TINY":  ["cerebras", "github", "openrouter", "groq", "nvidia", "gemini", "ollama"],
    "LARGE": ["cerebras", "gemini", "groq", "nvidia", "github", "openrouter", "ollama"],
}
